(window.webpackJsonp = window.webpackJsonp || []).push([
  [3, 22, 37, 40, 90],
  {
    ...
    310: function (t, e, s) {
      ...
      t.exports = function (t) {
        return (
          "string" == typeof t || (!i(t) && n(t) && "[object String]" == a(t))
        );
      };
    },
    311: function (t, e, s) {
      ...
      var r = {
          ...
          computed: {
            ...
            editLink() {
              ...
              return t && n && this.$page.relativePath
                ? this.createEditLink(e, n, s, a, this.$page.relativePath)
                : null;
            },
            editLinkText() {
              return (
          ...
          methods: {
            createEditLink(t, e, s, a, i) {
              ...
              return (
                (o.test(e) ? e : "https://github.com/" + e).replace(n, "") +
                "/edit" +
                `/${a}/` +
                (s ? s.replace(n, "") + "/" : "") +
                i
    ...
    319: function (t, e, s) {
      ...
      var a = s(287),
        ...
        l = {
          ...
          computed: {
            prev() {
              return u(c.PREV, this);
            },
            next() {
              return u(c.NEXT, this);
            },
          },
        };
      const c = {
      ...
      function u(
        t,
        { $themeConfig: e, $page: s, $route: i, $site: o, sidebarItems: l }
      ) {
        const {
            resolveLink: c,
            getThemeLinkConfig: u,
            getPageLinkConfig: d,
          } = t,
          h = u(e),
          p = d(s),
      ...
      function d(t, e, s) {
        ...
        !(function t(e, s) {
          for (let a = 0, i = e.length; a < i; a++)
            "group" === e[a].type ? t(e[a].children || [], s) : s.push(e[a]);
        })(e, a);
      ...
      var a = s(312),
        ...
        n = {
          ...
          mounted() {
            ...
            //   (!t ||
            //     Date.parse(new Date()) / 1e3 > t ||
            //     t - Date.parse(new Date()) / 1e3 > 43200) &&
    ...
    416: function (t, e, s) {
      ...
      var a = s(124),
        ...
        n = (t, e, s = null) => {
          let a = i()(e, "title", "");
          return (
            i()(e, "frontmatter.tags") &&
              (a += " " + e.frontmatter.tags.join(" ")),
            s && (a += " " + s),
            o(t, a)
          );
        };
      const o = (t, e) => {
        const s = (t) => t.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$&"),
          ...
          i = t
            ...
            .map((t) => t.trim())
            .filter((t) => !!t);
        if (a.test(t)) return i.some((t) => e.toLowerCase().indexOf(t) > -1);
        {
          const a = t.endsWith(" ");
          return new RegExp(
            i
          ...
          computed: {
            ...
            suggestions() {
              ...
              const { pages: e } = this.$site,
                s = this.$site.themeConfig.searchMaxSuggestions || 5,
                a = this.$localePath,
                i = [];
              for (let o = 0; o < e.length && !(i.length >= s); o++) {
                const r = e[o];
                if (this.getPageLocalePath(r) === a && this.isSearchable(r))
                  if (n(t, r)) i.push(r);
                  else if (r.headers)
                    for (
                      let e = 0;
                      e < r.headers.length && !(i.length >= s);
                      e++
                    ) {
                      const s = r.headers[e];
                      s.title &&
            ...
            return e("div", { staticClass: "search-box" }, [
              ...
              t.showSuggestions
                ? e(
                    ...
                    t._l(t.suggestions, function (s, a) {
                      return e(
                        "li",
                        {
                          key: a,
                          staticClass: "suggestion",
                          class: { focused: a === t.focusIndex },
                          on: {
                          ...
                          e(
                            ...
                            [
                              e("span", { staticClass: "page-title" }, [
                                t._v(t._s(s.title || s.path)),
                              ]),
                              t._v(" "),
                              s.header
                                ? e("span", { staticClass: "header" }, [
                                    t._v("> " + t._s(s.header.title)),
                                  ])
                                : t._e(),
                            ]
                          ),
      ...
      var p = {
          ...
          mounted() {
            const t =
                parseInt(h(this.$el, "paddingLeft")) +
                parseInt(h(this.$el, "paddingRight")),
              e = () => {
          ...
          methods: {
            noMoreTips() {
              localStorage.setItem("showV2Tips", !0), location.reload();
            },
          },
        },
        g =
          ...
          Object(l.a)(
            ...
            function () {
              var t = this,
                e = t._self._c;
              return e("div", { class: { "custom-navbar": t.showV2Tips } }, [
                t.showV2Tips
                  ? e("div", { staticClass: "showV2Tips jump-link" }, [
                      t._v(
                ...
                e(
                  ...
                  {
                    staticClass: "navbar",
                    style: { position: t.showV2Tips ? "relative" : "fixed" },
                  },
                  [
                    e("SidebarButton", {
                      on: {
    ...
    417: function (t, e, s) {
      ...
      s.r(e);
      var a = {
          components: { NavLink: s(290).default },
          computed: {
            data() {
                ...
                [
                  ...
                  t.data.features && t.data.features.length
                    ? e(
                        ...
                        t._l(t.data.features, function (s, a) {
                          return e("div", { key: a, staticClass: "feature" }, [
                            e("h2", [t._v(t._s(s.title))]),
                            t._v(" "),
                            e("p", [t._v(t._s(s.details))]),
                          ]);
                        }),
                        0
                      )
        ...
        n = {
          ...
          created() {
            if ("undefined" != typeof window)
              switch (
                ((this.apiShow = localStorage.getItem("apiShow")
                  ? localStorage.getItem("apiShow")
                  : "composition"),
                console.log(this.apiShow, "apiShow"),
                this.apiShow)
              ) {
                case "options":
                  document
                    .querySelector("#app")
                    .classList.remove("show-composition"),
                    document
                      .querySelector("#app")
                ...
                default:
                  document
                    ...
                    document
                      .querySelector("#app")
                      .classList.add("show-composition");
              }
          },
          methods: {
            apiChange(t) {
              if ("undefined" != typeof window)
                switch ((localStorage.setItem("apiShow", t), this.apiShow)) {
                  case "options":
                    document
                      .querySelector("#app")
                      .classList.remove("show-composition"),
              ...
              e(
                ...
                [
                  e(
                    "a",
                    {
                      staticClass: "jump-linker",
                      attrs: {
                        target: "_blank",
                        href: "https://ext.dcloud.net.cn/plugin?id=20103",
                      },
                    },
                    [
                      e("img", {
                        attrs: {
                          src: t.$withBase("/customer/uiadmin-unicloud.png"),
                        },
                      }),
                    ]
                  ),
                  ...
                  e(
                    "div",
                    { staticClass: "jump-linker", attrs: { target: "_blank" } },
                    [
                      e("img", {
                        attrs: { src: t.$withBase("/customer/contact1.png") },
                      }),
                    ]
                  ),
                  t._v(" "),
                  e(
                    ...
                    [
                      e("el-switch", {
                        attrs: {
                          "active-value": "composition",
                          "inactive-value": "options",
                          "active-text": "组合式",
                          "inactive-text": "选项式",
                        },
                        on: { change: t.apiChange },
                        model: {
                          value: t.apiShow,
                          callback: function (e) {
                            t.apiShow = e;
                  ...
                  t._t("top"),
                  t._v(" "),
                  e("SidebarLinks", { attrs: { depth: 0, items: t.items } }),
                  t._v(" "),
                  t._t("bottom"),
                ],
                2
          ...
          methods: {
            ...
            onTouchEnd(t) {
              const e = t.changedTouches[0].clientX - this.touchStart.x,
                s = t.changedTouches[0].clientY - this.touchStart.y;
